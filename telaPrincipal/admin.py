...
from .models import Maquinas, Maquina, Estruturas, Estrutura, Setores, Locais, HourlyScheduleManagement, HourlyScheduleManagementRealizado, HSMEmProcesso, TarefasGerais
...
admin.site.register(TarefasGerais)

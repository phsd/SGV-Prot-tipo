...
class Estrutura (models.Model):
    ...
    dataEntregaMax = models.DateTimeField(blank=False)
    dataEntradaSistema = models.DateTimeField(blank=False)
    dataInicioManufatura = models.DateTimeField(blank=False)
    dataBaixaCorte = models.DateTimeField(blank=True)
    dataBaixaCaldSolda = models.DateTimeField(blank=True)
    dataBaixaUsinagem = models.DateTimeField(blank=True)
    dataBaixaPintura = models.DateTimeField(blank=True)
    dataConfirmEntrega = models.DateTimeField(blank=True)
